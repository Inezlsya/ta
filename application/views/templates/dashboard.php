    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-success justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">SE CATIN</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('catin'); ?>">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Catin</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('edu'); ?>">
                    <i class="fas fa-fw fa-box"></i>
                    <span>Edukasi</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('kuesioner'); ?>">
                    <i class="fas fa-fw fa-box"></i>
                    <span>Kuesioner</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('konsultasi'); ?>">
                    <i class="fas fa-fw fa-box"></i>
            ...
            <!-- <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('atk'); ?>">ATK & Jasa</a>
                        <a class="collapse-item" href="<?= base_url('nonatk'); ?>">Non ATK</a>
