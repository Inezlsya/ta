                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('nama_catin'); ?>" name="nama_catin" id="nama_catin" type="text" class="form-control" placeholder="Nama Catin...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('no_ktp'); ?>" name="no_ktp" id="no_ktp" type="text" class="form-control" placeholder="Nomor KTP...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <select value="<?= set_value('jk'); ?>" name="jk" id="nama_supplier" type="text" class="form-control" placeholder="Jenis Kelamin...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <select value="<?= set_value('status'); ?>" name="status" id="status" type="text" class="form-control" placeholder="Nama Supplier...">
