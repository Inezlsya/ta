    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-warning">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="kode_jenis">Kode Non Atk</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('kode_jenis'); ?>" name="kode_jenis" id="kode_jenis" type="text" class="form-control" placeholder="Masukan 1 digit kode...">
